...
Inheritance diagram for Eigen\+::Num\+Traits$<$ T $>$\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=246pt]{struct_eigen_1_1_num_traits__inherit__graph}
\end{center}
\end{figure}


Collaboration diagram for Eigen\+::Num\+Traits$<$ T $>$\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=246pt]{struct_eigen_1_1_num_traits__coll__graph}
\end{center}
\end{figure}
